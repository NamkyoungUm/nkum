...
const DiaryList = ({data})=>{
    ...
    useEffect(()=>{
        ...
        const copyList = JSON.parse(JSON.stringify(data)); //복사본에 정렬결과 넣음
        copyList.sort(compare);                 //copyList에 저장된 일기데이터 정렬
        setSortedData(copyList);          //정렬된 copyList로 sortedData를 업데이트
    }, [data, sortType]);
